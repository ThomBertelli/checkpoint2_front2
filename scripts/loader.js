function mostrarSpinner() {
    const ingressarReference = document.getElementById('ingressar')
    const goToLoginReference = document.getElementById('goToLogin')
    
    if(ingressarReference){
        ingressarReference.style.display = "none"
    }   
    if(goToLoginReference){
        goToLoginReference.style.display = "none"
    }
...
function ocultarSpinner() {
    ...
    if(ingressarReference){
        ...
        ingressarReference.style.display = "block"
